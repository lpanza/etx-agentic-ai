...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"lpanza","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'lpanza', repo 'etx-agentic-ai', "
